...
const STR = {
  en: {
    ...
    privP: 'This is a static page. There is no server to send anything to, no account, no analytics and no third-party script. The file you drop in is opened by code running in your browser and is gone when you close the tab. Worth knowing: a Spotify export contains your IP addresses. This page reads the artist, the track and the timestamp, and nothing else.',
    cCount: 'Nights',
    cWhere: 'Where',
    cRoom: 'Rooms',
    rAny: 'Any size',
  ...
  da: {
    ...
    privP: 'Det her er en statisk side. Der er ingen server at sende noget til, ingen konto, ingen analytics og ingen tredjepartsscripts. Filen du lægger ind, åbnes af kode i din browser og er væk, når du lukker fanen. Værd at vide: en Spotify-eksport indeholder dine IP-adresser. Siden læser kunstner, titel og tidspunkt, og intet andet.',
    cCount: 'Aftener',
    cWhere: 'Hvor',
    cRoom: 'Rum',
